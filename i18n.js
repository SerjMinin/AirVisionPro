...
const I18N = {
  en: { _name:"English", login_title:"AirVision Pro", email:"Email", password:"Password", enter:"Sign in", err_login:"Wrong email or password",
    ...
    set_config:"Configuration", cfg_site:"Site only", cfg_out:"Site + outdoor", cfg_full:"Site + outdoor + indoor",
    set_devices:"Devices", set_location:"Location", set_lat:"Latitude", set_lon:"Longitude",
    set_alt_sea:"Altitude a.s.l.", set_alt_ground:"Install height",
    set_units:"Units", set_rounding:"Temp. rounding", round_int:"Integer", round_1:"1 decimal",
    set_pressure_thr:"Pressure thresholds", thr_anom_low:"Abnormally low", thr_low:"Low", thr_normal:"Normal", thr_high:"High",
    set_sources:"Data sources", set_tabs:"Visible tabs",
  ...
  ru: { _name:"Русский", login_title:"AirVision Pro", email:"Email", password:"Пароль", enter:"Войти", err_login:"Неверный email или пароль",
    ...
    set_config:"Конфигурация", cfg_site:"Только сайт", cfg_out:"Сайт + уличное", cfg_full:"Сайт + уличное + домашнее",
    set_devices:"Устройства", set_location:"Локация", set_lat:"Широта", set_lon:"Долгота",
    set_alt_sea:"Высота над морем", set_alt_ground:"Высота установки",
    set_units:"Единицы", set_rounding:"Округление темп.", round_int:"Целое", round_1:"1 знак",
    set_pressure_thr:"Пороги давления", thr_anom_low:"Аномально низкое", thr_low:"Низкое", thr_normal:"Нормальное", thr_high:"Высокое",
    set_sources:"Источники данных", set_tabs:"Показывать вкладки",
