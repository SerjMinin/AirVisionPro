...
const I18N = {
  en: { _name:"English", login_title:"AirVision Pro", email:"Email", password:"Password", enter:"Sign in", err_login:"Wrong email or password",
    ...
    set_title:"Settings", set_save:"Save", set_cancel:"Cancel",
    set_config:"Configuration", cfg_site:"Site only (Open-Meteo, OpenWeatherMap)", cfg_out:"Site + outdoor", cfg_full:"Site + outdoor + indoor",
    set_sources:"Data sources", src_sensor:"Device sensors",
    set_devices:"Devices", set_location:"Location", set_lat:"Latitude", set_lon:"Longitude", set_alt_sea:"Altitude a.s.l.", set_alt_ground:"Install height",
    set_tabs:"Visible tabs",
    set_page:"Parameter: ", set_unit:"Unit", unit_fixed:"fixed", unit_none:"none",
    set_rounding:"Temp. rounding", round_int:"Integer", round_1:"1 decimal",
    set_pressure_thr:"Pressure thresholds", thr_anom_low:"Abnormally low", thr_low:"Low", thr_normal:"Normal", thr_high:"High",
    thr_auto:"Auto by altitude", thr_auto_hint:"Thresholds computed from altitude a.s.l.", thr_manual_hint:"Manual thresholds",
    tab_advice:"Smart tips", tab_smart:"Smart home",
    api_hint:"Send outdoor station data to external services.", api_enable:"Enable", api_config:"Configure",
    api_soon:"Configuration dialog coming soon.", api_saved:"Saved.",
    advice_soon:"Smart tips — under development.", smart_soon:"Home Assistant / MQTT — under development.",
    thr_auto:"Auto pressure recalc by altitude", thr_auto_hint:"Thresholds computed by altitude a.s.l.", thr_manual_hint:"Manual thresholds",
    thr_anom_high:"Abnormally high",
    tab_geomag:"Geomagnetic storms", tab_advice:"Smart tips", tab_smart:"Smart home",
    api_hint:"Send real sensor data to external services.", api_enable:"Enable", api_config:"Configure",
    api_soon:"Configuration dialog coming soon.", api_saved:"Saved.",
    adv_output:"Output settings", adv_mode:"Mode", adv_seq:"One by one", adv_marquee:"Marquee", adv_crit_first:"Critical first",
    adv_list:"Tips list", adv_hint:"Uncheck to disable. Disabled = no data for your configuration.",
    geomag_soon:"Geomagnetic storms (NOAA SWPC, Kp) — under development.",
    smart_soon:"Home Assistant / MQTT — under development.",
    set_close:"Close",
    thr_auto:"Auto pressure recalc by altitude", thr_auto_hint:"Thresholds computed by altitude a.s.l.", thr_manual_hint:"Manual thresholds",
    thr_anom_high:"Abnormally high",
    tab_geomag:"Geomagnetic storms", tab_advice:"Smart tips", tab_smart:"Smart home",
    api_hint:"Send real sensor data to external services.", api_enable:"Enable", api_config:"Configure",
    api_soon:"Configuration dialog coming soon.", api_saved:"Saved.",
    adv_output:"Output settings", adv_mode:"Mode", adv_seq:"One by one", adv_marquee:"Marquee",
    adv_crit_first:"Critical important first", adv_list:"Tips list", advice_soon:"Smart tips — under development.",
    sh_title:"Home Assistant system", sh_json:"Send data as JSON", sh_mqtt:"Send data via MQTT API", sh_rest:"Send data via REST API", sh_config:"Settings",
    smart_soon:"Home Assistant / MQTT — under development.",
    geomag_load:"Loading NOAA SWPC data…", geomag_err:"Failed to load geomagnetic data.",
    geomag_calm:"Calm (below G1)", geomag_calm_desc:"Geomagnetic field is quiet, no storm.",
    geomag_updated:"Updated", geomag_source:"Source: NOAA SWPC (planetary Kp).",
    set_key:"Key", set_interval:"Send interval, min",
    geomag_fact:"Observed", geomag_fcst:"Forecast", geomag_day:" day", geomag_aurora:"Aurora possible",
    geomag_d1:"Forecast, day 1", geomag_d2:"Forecast, day 2", geomag_d3:"Forecast, day 3",
    geomag_calm:"calm", geomag_err:"Failed to load geomagnetic data.",
  ...
  ru: { _name:"Русский", login_title:"AirVision Pro", email:"Email", password:"Пароль", enter:"Войти", err_login:"Неверный email или пароль",
    ...
    set_title:"Настройки", set_save:"Сохранить", set_cancel:"Отмена",
    set_config:"Конфигурация", cfg_site:"Только сайт (Open-Meteo, OpenWeatherMap)", cfg_out:"Сайт + уличное устройство", cfg_full:"Сайт + уличное + домашнее устройства",
    set_sources:"Источники данных", src_sensor:"Датчики устройств",
    set_devices:"Устройства", set_location:"Локация", set_lat:"Широта", set_lon:"Долгота", set_alt_sea:"Высота над морем", set_alt_ground:"Высота установки",
    set_tabs:"Показывать вкладки",
    set_page:"Параметр: ", set_unit:"Единица", unit_fixed:"фиксированная", unit_none:"нет",
    set_rounding:"Округление темп.", round_int:"Целое", round_1:"1 знак",
    set_pressure_thr:"Пороги давления", thr_anom_low:"Аномально низкое", thr_low:"Низкое", thr_normal:"Нормальное", thr_high:"Высокое",
    thr_auto:"Авто по высоте", thr_auto_hint:"Пороги рассчитаны по высоте над морем", thr_manual_hint:"Ручные пороги",
    tab_advice:"Умные советы", tab_smart:"Умный дом",
    api_hint:"Отдача данных уличной станции во внешние сервисы.", api_enable:"Включить", api_config:"Настроить",
    api_soon:"Окно настройки появится позже.", api_saved:"Сохранено.",
    advice_soon:"Умные советы — раздел в разработке.", smart_soon:"Home Assistant / MQTT — раздел в разработке.",
    thr_auto:"Авто пересчёт давления по высоте", thr_auto_hint:"Пороги рассчитаны по высоте над уровнем моря", thr_manual_hint:"Ручные пороги",
    thr_anom_high:"Аномально высокое",
    tab_geomag:"Магнитные бури", tab_advice:"Умные советы", tab_smart:"Умный дом",
    api_hint:"Отдача данных реальных датчиков во внешние сервисы.", api_enable:"Включить", api_config:"Настроить",
    api_soon:"Окно настройки появится позже.", api_saved:"Сохранено.",
    adv_output:"Настройки вывода", adv_mode:"Режим", adv_seq:"По очереди", adv_marquee:"Бегущая строка", adv_crit_first:"Критические впереди",
    adv_list:"Список советов", adv_hint:"Снимите галку, чтобы отключить. Недоступно = нет данных по вашей конфигурации.",
    geomag_soon:"Магнитные бури (NOAA SWPC, Kp) — раздел в разработке.",
    smart_soon:"Home Assistant / MQTT — раздел в разработке.",
    set_close:"Закрыть",
    thr_auto:"Авто пересчёт давления по высоте", thr_auto_hint:"Пороги рассчитаны по высоте над уровнем моря", thr_manual_hint:"Ручные пороги",
    thr_anom_high:"Аномально высокое",
    tab_geomag:"Магнитные бури", tab_advice:"Умные советы", tab_smart:"Умный дом",
    api_hint:"Отдача данных реальных датчиков во внешние сервисы.", api_enable:"Включить", api_config:"Настроить",
    api_soon:"Окно настройки появится позже.", api_saved:"Сохранено.",
    adv_output:"Настройки вывода", adv_mode:"Режим", adv_seq:"По очереди", adv_marquee:"Бегущая строка",
    adv_crit_first:"Критические важные впереди", adv_list:"Список советов", advice_soon:"Раздел в разработке.",
    sh_title:"Система Home Assistant", sh_json:"Отдаём данные в формате JSON", sh_mqtt:"Отдаём данные через MQTT API", sh_rest:"Отдаём данные через REST API", sh_config:"Настройки",
    smart_soon:"Раздел в разработке.",
    geomag_load:"Загрузка данных NOAA SWPC…", geomag_err:"Не удалось загрузить данные о магнитных бурях.",
    geomag_calm:"Спокойно (ниже G1)", geomag_calm_desc:"Геомагнитное поле спокойное, бури нет.",
    geomag_updated:"Обновлено", geomag_source:"Источник: NOAA SWPC (планетарный Kp).",
    set_key:"Ключ", set_interval:"Интервал отправки, мин",
    geomag_fact:"Факт", geomag_fcst:"Прогноз", geomag_day:" сутки", geomag_aurora:"Возможно сияние",
    geomag_d1:"Прогноз на первые сутки", geomag_d2:"Прогноз на вторые сутки", geomag_d3:"Прогноз на третьи сутки",
    geomag_calm:"спокойно", geomag_err:"Не удалось загрузить данные о магнитных бурях.",
  ...
  "pt-BR": { _name:"Português", login_title:"AirVision Pro", email:"E-mail", password:"Senha", enter:"Entrar", err_login:"E-mail ou senha incorretos",
