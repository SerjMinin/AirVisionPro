 ...
 */
/* AirVisionPro — локализация (11 языков). */
...
const I18N = {
  ...
  ru: { _name:"Русский", login_title:"AirVisionPro", email:"Email", password:"Пароль", enter:"Войти", err_login:"Неверный email или пароль",
    ...
    loading:"Загрузка…",
    set_title:"Главные настройки", set_save:"Сохранить", set_cancel:"Отмена",
    set_config:"Источники данных", cfg_site:"Только сайт (Open-Meteo, OpenWeatherMap)", cfg_out:"Сайт + уличное устройство", cfg_full:"Сайт + уличное + домашнее устройства",
    set_sources:"Источники данных", src_sensor:"Датчики устройств",
    set_devices:"Физические устройства", set_location:"Местоположение", set_lat:"Широта", set_lon:"Долгота", set_alt_sea:"Высота над уровнем моря", set_alt_ground:"Высота установки от замли",
